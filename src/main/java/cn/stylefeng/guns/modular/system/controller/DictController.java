...
public class DictController extends BaseController {
	...
	@ResponseBody
	public Object render(@RequestParam(name = "code") String code) {
		List<Dict> dicts = dictService.selectByCode(code);
		if (dicts != null && dicts.size() == 1) {
			Dict dict = dicts.get(0);
			return dictService.selectList(new EntityWrapper<Dict>().eq("pid", dict.getId()));
		}
		return null;
	}
